param(
  [string]$MigrationName = "batch_operations_v2"
)
...
Write-Host "WiseERPEnterprise - lote Operacoes v2" -ForegroundColor Green
Write-Host "Inclui: Filiais, Categorias, Transferencias, Estornos e Relatorios"
...
Write-Host "`nLOTE OPERACOES V2 CONCLUIDO COM SUCESSO." -ForegroundColor Green
