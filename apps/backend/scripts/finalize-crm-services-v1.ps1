...
npx prisma migrate dev --name batch_crm_services_v1; if ($LASTEXITCODE -ne 0) { exit $LASTEXITCODE }
...
Write-Host "LOTE CRM + SERVICOS V1 CONCLUIDO COM SUCESSO." -ForegroundColor Green
